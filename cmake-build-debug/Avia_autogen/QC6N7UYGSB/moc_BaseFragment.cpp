...
void BaseFragment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->provideThemeChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (BaseFragment::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseFragment::provideThemeChanged)) {
                *result = 7;
                return;
            }
        }
...
// SIGNAL 7
void BaseFragment::provideThemeChanged()
{
